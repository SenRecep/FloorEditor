...
jQuery.trumbowyg = {
  ...
  var i = function i(o, r) {
    ...
    if (i.hasSvg = d !== !1, d !== !1 && (l.svgAbsoluteUseHref || 0 === a("#" + s, i.doc).length)) {
      ...
      if (null == d) console.warn("You must define svgPath: https://goo.gl/CfTY9U");else if (!l.svgAbsoluteUseHref) {
  ...
  i.prototype = {
    ...
    toggleSpan: function toggleSpan(e) {
      var t = this;
    ...
    semanticTag: function semanticTag(e, t, n) {
      var o,
          r = this,
          i = e;
      if (null != this.o.semantic && "object" == _typeof(this.o.semantic) && this.o.semantic.hasOwnProperty(e)) o = this.o.semantic[e];else {
    ...
    createLink: function createLink() {
      for (var e, t, n, o = this, r = o.doc.getSelection(), i = r.getRangeAt(0), s = r.focusNode, l = new XMLSerializer().serializeToString(i.cloneContents()) || i + ""; ["A", "DIV"].indexOf(s.nodeName) < 0;) {
        s = s.parentNode;
      }
    ...
    execCmd: function execCmd(e, n, o, r) {
      var i = this;
    ...
    openModal: function openModal(e, n, i) {
      var s = this,
          l = s.o.prefix;
    ...
    updateButtonPaneStatus: function updateButtonPaneStatus() {
      ...
      e.clearButtonPaneStatus(), a.each(r, function (r, i) {
        ...
        if (l.length > 0) l.addClass(n);else try {
